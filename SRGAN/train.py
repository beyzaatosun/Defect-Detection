...
"""
# Train 2X SRGAN
python train.py --train SRGANKerasmaster/data/IMAGES --validation SRGANKerasmaster/data/IMAGES --scale 2 --test_path images/samples_2X --stage gan

# Train the 4X SRGAN
python train.py --train Kaggle-imagenet/input/DET/train --validation Kaggle-imagenet/input/DET/test --scale 4 --test_path images/samples_4X --scaleFrom 2

# Train the 8X SRGAN
python train.py --train Kaggle-imagenet/input/DET/train --validation Kaggle-imagenet/input/DET/test --scale 8 --test_path images/samples_8X --scaleFrom 4
"""
...
def parse_args():
    ...
    parser.add_argument(
        '-test', '--test',
        type=str, default='data/Sc_109.jpg',
        help='Folder with testing images'
    )
        
    parser.add_argument(
        '-dataname', '--dataname',
        type=str, default='NEU',
        help='Dataset name, e.g. \'NEU\''
    )
